...
spark = SparkSession.builder \
      .master("local[2]") \
      .appName("top_20_words_positive.com") \
      .getOrCreate()
...
#def top_20_words_df():
shakeWordsSplitDF = (only_positive_df
                        .select(split(only_positive_df.review, '\s+').alias('split')))
...
top_20_words_positive = WordsAndCountsDF.orderBy("count", ascending=0).limit(20).cache()
#top_20_words_positive.write.mode("overwrite").parquet("D:/progetti/progetto/tmp/top_20_words_positive")